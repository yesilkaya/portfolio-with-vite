export const messages = {
    ...
    // ================= BACKEND =================
    db: {
      created: (dbName: string) => `✅ Veritabanı '${dbName}' yoksa oluşturuldu.`,
    ...
    contact: {
      ...
      send_success: (msg: string) => `Mesaj başarıyla gönderildi! ✉️\n${msg}`,
      send_error: (err: string) => `❌ Hata: ${err}`,
    },
    ...
    feedback: {
      ...
      update_error: (err: string) => `❌ Güncelleme hatası: ${err}`,
